pub mod oct_dag {
	...
	const _POSITIVE_X: u32 = 1;
	const _POSITIVE_Y: u32 = 2;
	const _POSITIVE_Z: u32 = 4;
	...
	//should produce some code that is useful later for cleaning repetition out of the dags
	impl OctDag {
		...
		/*
		TODO: creat some sort of means of telling that a node is the chile of another, ie a string that records the position of each node "707"
		 */
